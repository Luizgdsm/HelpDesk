                ...
                <div class="col">
                  ...
                  <form action="soapFechamento.php" method="post">
                    ...
                    <div class="row mt-5">
                     ...
                     <input type="hidden" name="tituloChamado" value="<?php print_r($_POST["titulo"]);?>">
                    <input type="hidden" name="categoriaChamado" value="<?php print_r($_POST["categoria"]);?>">
                    <input type="hidden" name="descricaoChamado" value="<?php print_r($_POST["descricao"]);?>">
                    <input type="hidden" name="statusChamada" value="<?php print_r($_POST["statusChamada"]);?>">
                    <input type="hidden" name="idChamado" value="<?php print_r($_POST["idChamado"]);?>">
                    <input type="hidden" name="numChamado" value="<?php print_r($_POST["numChamado"]);?>">
                     <input type="hidden" name="email" value="<?php print_r($_POST["email"]);?>">
                  </form>
